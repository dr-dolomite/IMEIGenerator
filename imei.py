...
def main():
    ...
    while True:
        try:
            count_input = str(
                input(' Enter the number of IMEI numbers to generate: ')).strip()
            print(
                ' ======================================================================')
        except KeyboardInterrupt:
            print('')
    ...
    print('')
    print(' ======================================================================')
    choiceA = int(input(' Type 1 to exit or 2 to generate again:'))
    if (choiceA == 1):
        os.system('exit')
    if (choiceA == 2):
